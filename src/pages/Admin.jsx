...
function AdminDashboard() {
  ...
  const [complaints] = useState([
    {
      ...
      image: 'https://images.unsplash.com/photo-1625228446534-d54ff2b1f6ab?w=400&h=300&fit=crop',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1621544402532-9f4e1f5d0ca5?w=400&h=300&fit=crop',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1611857308091-a5e3bc6c4137?w=400&h=300&fit=crop',
  ...
  const filteredComplaints = complaints.filter(complaint => {
    ...
    const locationMatch = filters.location === 'All' || complaint.city === filters.location;
    const searchMatch = filters.searchQuery === '' || 
      complaint.id.toLowerCase().includes(filters.searchQuery.toLowerCase()) ||
      complaint.location.toLowerCase().includes(filters.searchQuery.toLowerCase()) ||
      complaint.reporterName.toLowerCase().includes(filters.searchQuery.toLowerCase());
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
            <div className="text-3xl font-bold text-gray-800">{stats.fixed}</div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <div className="flex bg-gray-100 rounded-lg p-1">
                <button
                  ...
                  className={`px-4 py-1 rounded ${viewMode === 'grid' ? 'bg-white shadow' : ''}`}
                >
                ...
                <button
                  ...
                  className={`px-4 py-1 rounded ${viewMode === 'table' ? 'bg-white shadow' : ''}`}
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
        ...
        {viewMode === 'grid' && (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredComplaints.map(complaint => (
              <div key={complaint.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow">
                {/* Image */}
                ...
                <div className="p-5">
                  <div className="mb-3">
                    <div className="flex items-start justify-between mb-2">
                      <h3 className="font-bold text-gray-800 text-lg">{complaint.reporterName}</h3>
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex items-start gap-2">
                      ...
                      <span className="text-sm text-gray-700">{complaint.location}</span>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-gray-700">
                        {new Date(complaint.dateReported).toLocaleDateString('en-IN', {
                          year: 'numeric',
                          month: 'short',
                          day: 'numeric'
                        })}
                  ...
                  {filteredComplaints.map(complaint => (
                    <tr key={complaint.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <div className="text-sm text-gray-900 max-w-xs">{complaint.location}</div>
                        <div className="text-xs text-gray-500">{complaint.city}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
