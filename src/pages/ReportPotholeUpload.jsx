      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-blue-900 mb-1">Tips for Better Reports</h3>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-8 max-w-sm w-full text-center">
            ...
            <p className="text-gray-600 mb-4">
              Your pothole report has been successfully submitted. You can track it in your dashboard.
            </p>
            <div className="text-sm text-gray-500">
              Report ID: RPT-{Math.random().toString(36).substr(2, 6).toUpperCase()}
            </div>
          </div>
        </div>
      )}
