        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-sm leading-relaxed">
              Raahi is a citizen-driven platform to report road issues and improve 
              infrastructure safety across India.
            </p>
          </div>
          ...
          <div className="text-center md:text-left">
            ...
            <div className="mt-6 p-3 bg-gray-700 rounded-lg border border-gray-600">
              <p className="text-xs text-gray-400 italic">
                <span className="font-semibold text-yellow-400">Disclaimer:</span> This is a demo civic-tech platform.
              </p>
            </div>
          </div>
        </div>
